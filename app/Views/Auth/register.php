...
<head>
    ...
    <title>Daily Finances — Register</title>
        ...
        <div class="card auth-card">
            <div class="card-body p-4">
                ...
                <div class="text-center mb-4">
                    ...
                    <p class="auth-subtitle">Buat akun kamu</p>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="password" name="konfirmasi" class="form-control" placeholder="ulangi kata sandi">
                </div>
                
                <button type="submit" class="btn btn-auth w-100 mt-2"> Daftar</button>
